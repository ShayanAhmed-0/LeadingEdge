  ...
  return (
    <div className="main_head">
      <div className="relative mt-16 bg-gradient-to-tr from-stone-900 to-stone-600">
        ...
        <div className="px-4 pt-12 mx-auto bg-gradient-to-tr from-stone-900 to-stone-600 sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
          <div className="flex justify-center">
            <div className="md:max-w-md lg:col-span-2">
              ...
              <div className="max-w-sm mt-4 sm:max-w-xl md:max-w-xl lg:max-w-xl">
                ...
                Partner with us for transformative technology solutions. Your success is our commitment.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col justify-between pt-5 pb-10 mt-4 border-t border-deep-purple-accent-200 sm:flex-row">
            ...
            <div className="flex items-center mt-4 space-x-4 sm:mt-0">
              <a
                href="https://www.facebook.com/profile.php?id=61551880342722" target='_blank'
              ...
              <a
                href="https://www.instagram.com/leadingedgeltd/" target='_blank'
                className="transition-colors duration-300 text-deep-purple-100 hover:text-teal-accent-400"
              >
