...
const Explorecontent = () => {
    const revealConfig = {
      ...
      useEffect(() => {
        ScrollReveal().reveal(".card", revealConfig);
      }, []);
  return (
    <div>
       <div className="waju"> 
...
<h1 class="home-title">
  <span className="sp1">Crafting Digital Excellence: </span>
  <span className="sp1">Breathing life into websites</span>
</h1>
            ...
            <div class="card">
                ...
                <div class="flip-card__container">
                  <div class="card-front">
                    <div class="card-front__tp card-front__tp--city">
                      ...
                      <h2 class="card-front__heading">Mobtop</h2>
                      <p class="card-front__text-price">E-Commerce Site</p>
                    </div>
              ...
              <div class="inside-page">
                <div class="inside-page__container">
                  ...
                  Unlock your tech desires! Explore the newest laptops and mobiles at unbeatable prices. Shop now and upgrade your digital world!
                  </p>
                  <a href="https://mobtop-react.vercel.app/" class="inside-page__btn inside-page__btn--city">
                    Visit Site
                  </a>
                </div>
              </div>
            ...
            <div class="card">
                ...
                <div class="flip-card__container">
                  <div class="card-front">
                    <div class="card-front__tp card-front__tp--ski">
                      ...
                      <h2 class="card-front__heading">Crazy Convertor</h2>
                      <p class="card-front__text-price">Conversion Site </p>
                    </div>
              ...
              <div class="inside-page">
                <div class="inside-page__container">
                  ...
                  <p class="inside-page__text">
                  &ldquo; Boost conversions effortlessly! Explore top-notch conversion tools. Elevate your success – Start now!&rdquo;
                  </p>
                  <a href="https://cc-lime.vercel.app/" class="inside-page__btn inside-page__btn--ski">
                    View site
                  </a>
                </div>
              </div>
            ...
            <div class="card">
                ...
                <div class="flip-card__container">
                  <div class="card-front">
                    <div class="card-front__tp card-front__tp--beach">
                      ...
                      <h2 class="card-front__heading">CleverBot 2</h2>
                      <p class="card-front__text-price">A Conversational Chatbot</p>
                    </div>
              ...
              <div class="inside-page">
                <div class="inside-page__container">
                  ...
                  <p class="inside-page__text">
                  Upgrade your chats! Discover our chatbot solutions for better conversations. Get started now!
                  </p>
                  <a href="https://cleverbot2.com/" class="inside-page__btn inside-page__btn--beach">
                    View site
                  </a>
                </div>
              </div>
            ...
            <div class="card">
                ...
                <div class="flip-card__container">
                  <div class="card-front">
                    <div class="card-front__tp card-front__tp--camping">
                      ...
                      <h2 class="card-front__heading">Games Paa</h2>
                      <p class="card-front__text-price">A Games Heaven</p>
                    </div>

                    <div class="card-front__bt">
                      <p id='p1_' class="card-front__text-view card-front__text-view--camping">
                        View more
                      </p>
                    </div>
                  </div>
              ...
              <div class="inside-page">
                <div class="inside-page__container">
                  ...
                  Level up your playtime! Dive into online gaming fun today.
                  </p>
                  <a
                    href="https://gamespaa.com/"
                    class="inside-page__btn inside-page__btn--camping">
                    View deals
                  </a>
                </div>
              </div>
