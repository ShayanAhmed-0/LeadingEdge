...
const submitButton=async(e)=>{
  ...
  return (
    <section className="py-20 lg:py-[120px] overflow-hidden relative z-10 px-20">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
               ...
               We are at your Service  😊😊 !!
                ...
                <TypewriterComponent
                  className="leading-relaxed text-gray-400 mb-9"
                  onInit={(typewriter) => {
                    typewriter
                      .typeString(
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-gray-300 text-body-color">0313-3960313</p>
                    <p className="text-gray-300 text-body-color">0312-2327867</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
        ...
        <input
          ...
          className="bg-slate-200/90 w-full rounded-full border-4 border-transparent py-3 px-[14px] text-black/80 text-body-color outline-none focus:border-black/80 focus-visible:shadow-none placeholder:text-gray-500"
        />
        {/* bg-slate-200/90 */}
      </div>
                  {/* <ContactInputBox
        ...
        />
                  ...
                  <div>
                    <button
                      ...
                      className="w-full p-3 font-bold text-gray-500 transition border-none bg-black/80 rounded-3xl hover:text-black/80 hover:bg-cyan-300">
                      Send Message
                    </button>
                  </div>
                </form>
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="bg-slate-200/90 w-full rounded-full border-4 border-transparent py-3 px-[14px] text-gray-400 text-body-color outline-none focus:border-black/80 focus-visible:shadow-none placeholder:text-gray-500"
        />
        {/* bg-slate-200/90 */}
      </div>
    </>
