          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <span className="block mb-4 text-base font-bold text-slate-200">
                  Contact Us
                </span>
                <h2 className="mb-6 text-[32px] font-bold uppercase text-stone-600 sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  GET IN TOUCH WITH US
                </h2>
                <TypewriterComponent
                  className="text-black leading-relaxed mb-9 text-body-color"
                  onInit={(typewriter) => {
                    typewriter
                      .typeString(
                        "We'd love to hear from you! Whether you have questions about our software solutions, need technical support, or want to explore partnership opportunities, our team is here to assist you. Feel free to reach out through the channels below, and we'll get back to you as soon as possible"
                      )
                      .start();
                  }}
                />
                <div className="mt-6 mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">
                      L 307 Buffer Zone Karachi 72500. Pakistan{" "}
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-body-color">0313-3960313</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-slate-200/90 rounded-lg shadow-xl sm:p-12">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-white bg-black font-bold  transition border rounded-3xl border-primary bg-primary hover:bg-stone-600">
                      Send Message
                    </button>
                  </div>
                </form>
    ...
    <>
      <div className="mb-6">
        <textarea
          ...
          name={name}
          className="bg-slate-200/90 border-4 w-full resize-none rounded-full border-gray-300 py-3 text-base text-body-color outline-none focus:border-primary focus-visible:shadow-none placeholder:text-gray-500 placeholder:text-center text-center focus:border-stone-600 px-9"
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="bg-slate-200/90 w-full rounded-full border-4 border-gray-300 py-3 px-[14px] text-base text-body-color outline-none focus:border-stone-600 focus-visible:shadow-none placeholder:text-gray-500"
        />
      </div>
    </>
  );
