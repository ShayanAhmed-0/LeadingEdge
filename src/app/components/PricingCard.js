    ...
    return (
        <div>
            <div className="flex flex-col items-center justify-center min-h-screen p-10 text-black md:p-20">
                <h2 className="text-5xl text-black hite font-bold">LEADING-EDGE PRODUCT PRICING</h2>
                ...
                <div className="flex flex-wrap items-center justify-center w-full max-w-4xl mt-8">
                    <div className="flex flex-col flex-grow mt-8 overflow-hidden bg-slate-300 rounded-lg shadow-lg">
                        <div className="flex flex-col items-center p-10 bg-custom-bg-1">
                            <span className="font-semibold uppercase">Responsive Weibsites</span>
                        ...
                        <div className="flex px-10 pb-10 justfy-center">
                            <button className="flex items-center justify-center w-full h-12 px-6 text-sm uppercase bg-gray-200 hover:bg-black hover:text-white duration-700 rounded-lg font-bold">Join now</button>
                        </div>
                    </div>
                        ...
                        <div className="p-10">
                            <ul>
                                ...
                                <li className="flex items-center">
                                    ...
                                    <span className="ml-2 font-semibold">PARAPHRSING APPS</span>
                                </li>
                            </ul>
                        </div>
                        <div className="flex px-10 pb-10 justfy-center">
