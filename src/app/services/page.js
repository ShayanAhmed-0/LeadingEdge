...
const Page = () => {
  ...
  return (
    ...
    <h1
          className="flex flex-col items-center justify-center mt-12 mb-12 text-4xl antialiased font-extrabold tracking-wide text-center text-transparent uppercase bg-center bg-cover bg-clip-text textsm:text-7xl shead"
          style={{
            backgroundImage:
