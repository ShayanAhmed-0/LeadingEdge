            ...
            <main class="main">
              <section class="card-area">
                  ...
                  <div class="card">
                    ...
                    <div class="inside-page">
                      <div class="inside-page__container">
                        <h3
                          id="h1_1"
                          class="inside-page__heading inside-page__heading--city"
                        >
                          Mobtop
                        </h3>
                        <p class="inside-page__text">
                          Unlock your tech desires! Explore the newest laptops
                          and mobiles at unbeatable prices. Shop now and upgrade
                          your digital world!
                        </p>
                        <a
                          href="https://mobtop-react.vercel.app/"
                ...
                <h1 class="home-title">
                  ...
                  <span className="sp1">
                    Transforming visions into excellence
                  </span>
                </h1>{" "}
                <br />
                <br />
                  ...
                  <div class="card">
                    ...
                    <div class="inside-page">
                      <div class="inside-page__container">
                        ...
                        <p class="inside-page__text">
                          &ldquo; Boost conversions effortlessly! Explore
                          top-notch conversion tools. Elevate your success –
                          Start now!&rdquo;
                        </p>
                        <a
                          href="https://cc-lime.vercel.app/"
                          class="inside-page__btn inside-page__btn--ski"
                        >
                          View site
                        </a>
                      </div>
                  ...
                  <div class="card">
                    ...
                    <div class="inside-page">
                      <div class="inside-page__container">
                        ...
                        <p class="inside-page__text">
                          Upgrade your chats! Discover our chatbot solutions for
                          better conversations. Get started now!
                        </p>
                        <a
                          href="https://cleverbot2.com/"
                  ...
                  <div class="card">
                      ...
                      <div class="flip-card__container">
                        <div class="card-front">
                          ...
                          <div class="card-front__bt">
                            <p
                              id="p1_"
                              class="card-front__text-view card-front__text-view--camping"
                            >
                              View more
                            </p>
                          </div>
                    ...
                    <div class="inside-page">
                      <div class="inside-page__container">
                        ...
                        <p class="inside-page__text">
                          Level up your playtime! Dive into online gaming fun
                          today.
                        </p>
                        <a
